...
## Process
After gathering the required data (link to it!), I used D3 to create a scatterplot of each state's data.  This allows the visualization t0 associate each point on the scatterplot with the appropriate data set.  The user can select a particular axis to view, and the plot will update the data with animation indicating how the data visualization has changed.
